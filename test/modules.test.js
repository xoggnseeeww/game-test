...
test("등록되는 화면 id와 경로가 겹치지 않는다", async () => {
  ...
  const all = [...commonScreens, ...adhdScreens, ...discScreens, ...coupleScreens, ...numpathScreens, ...basicConversationScreens, ...elementaryConversationScreens, ...dialogueScreens, ...reviewScreens];
