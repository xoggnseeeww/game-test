...
// D-75: 모든 문장은 grammarPoints에 실재하는 문법 포인트를 가리켜야 한다(오타·삭제된
...
// D-75 핵심 규칙: 챕터를 상황으로만 나누면 문법이 한 번 등장했다 사라진다 — 두 번째
...
// D-75: type이 "produce"인 문장은 정답 하나로 채점하지 않는 대신, 스스로 비교할 예시
