...
`basic-conversation`(기초 영어회화, 7세 이하 대상) 하나, 그 안 챕터는 4개(총 112문장)다 —
인사/기분 표현(30문장), 하루 일과(아침+식사+목욕/잠자리 통합, 32문장), 가족·자기소개
(24문장), 놀이터에서(놀이+날씨 통합, 26문장). 단어 나열이 아니라 일상대화 위주로
구성했고(어린이 애니메이션 참고, D-65), 시간순으로 이어지거나 소재가 겹치는 상황은
