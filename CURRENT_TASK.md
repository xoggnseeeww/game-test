...
## 현재 작업
없음 (딜레마 게임을 문항 뒤 강제 단계로 재배치 완료, 2026-07-27)

## 다음 작업 우선순위
1. **미니게임 목록이 비어 있음** — `/game`이 "준비 중" 빈 화면인데, 반응속도·딜레마 게임 둘 다 이미 동작한다.
   두 게임을 `/game` 목록에 노출하거나 홈 문구를 조정 / 관련 파일: `js/screens/home.js` `renderGameList()`
