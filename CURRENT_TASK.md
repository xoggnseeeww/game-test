...
등으로 개명해 URL 자체를 새로 만들었다(셸·테스트 참조도 같이 갱신). 관련 결정:
`docs/decisions/2027-h1.md` D-32(2026-07-30 갱신 3건 포함). 아직 main 머지 전.
**카카오 디벨로퍼스 OG 캐시 삭제를 세 URL 다시 해야 함** — 아래 "배포 후 확인 필요" 참고.
