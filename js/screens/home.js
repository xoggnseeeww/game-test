  ...
  app.appendChild(el(`
    <div>
      ...
      <div class="legal-block">
        ...
        <h3>광고</h3>
        <p>이 사이트는 Google AdSense를 통해 광고를 게재합니다. 광고가 표시되는
        과정에서 Google을 비롯한 광고 네트워크가 자체 정책에 따라 쿠키·기기 식별자를
        이용해 맞춤 광고를 제공할 수 있으며, 이는 과몰입구역이 직접 수집·보관하는 정보가
        아니라 광고 네트워크가 처리하는 정보입니다. Google의 광고 관련 개인정보 처리는
        <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener">Google 광고 정책 페이지</a>에서
        확인할 수 있습니다.</p>
