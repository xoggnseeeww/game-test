...
// 사용자 지적(D-77): "7세 이하는 반복이면 되지만 초등학교부터는 실질적 회화 및 언어 향상이
...
// D-82(각 학년에 챕터 하나씩 더 추가) 이후에도 여전히 다중 턴 대화형 도구(§3-7)는
...
// 참조하지 않고 이 학년 안에서 다시 정의했다(학년 트랙이 독립적이어야 한다는 게 D-77의
// 전제).
