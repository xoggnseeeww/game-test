...
js/learning/<toolId>/ 학습 카테고리 안의 독립 도구 1개 = 폴더 1개(게임과 같은 레지스트리
                      ...
                      향상에 부족하다고 판단해(D-77) 학년(GRADES) 한 겹을 더 얹고, 문장마다
                      ...
                      (D-78: produce엔 시도 전 hint, 연습 카드엔 문법 라벨, 마이페이지엔
                      weak 총합도 노출). 아직 안 만든 학년·챕터는 화면에 미리 노출하지
                      않는다 — 지금은 저학년 챕터 5개(학교 가는 날·교실에서·쉬는 시간·
                      좋아하는 것·체육 시간, 챕터당 20문장, D-79·D-82), 중학년 챕터
                      5개(수업과 과제·친구 관계·방과 후 생활·우리 동네·학교 행사,
                      챕터당 20문장, D-80·D-82), 고학년 챕터 5개(의견 나누기·꿈과 진로·
                      요즘 이슈·여행과 경험·협동과 리더십, 챕터당 20문장, D-81·D-82)까지
                      ...
                      나온 것 중 가장 큰 다음 번호를 전체에서 이어 붙인다(D-82). 문법은
